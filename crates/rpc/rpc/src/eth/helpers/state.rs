...
mod tests {
    ...
    #[tokio::test]
    async fn test_state_provider_interceptor_wraps_latest_state() {
        ...
        .state_provider_interceptor(move |state| {
    ...
    #[tokio::test]
    async fn test_state_provider_interceptor_wraps_state_at_block_id() {
        let calls = Arc::new(AtomicUsize::new(0));
        let interceptor_calls = calls.clone();
